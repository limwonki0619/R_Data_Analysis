...
# 7.1.7 원하는 데이터를 sql쿼리로 불러오기 - read.csv.sql() ----------------------------------------------------------------
...
# 7.1.8 클립보드 내용을 사용해 데이터 프레임 생성하기 - read.delim()  ------------------------------------------------------
